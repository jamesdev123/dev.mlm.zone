...
(function($) {
	$.fn.multiscroll = function(options) {
		...
		$(document).on('click', '#button-challenge-more', function(e){
        e.preventDefault();
        var index = $(this).index();
        scrollPage($('.ms-left .ms-section').eq(2));
    });

		$(document).on('click', '#button-solution-more', function(e){
        e.preventDefault();
        var index = $(this).index();
        scrollPage($('.ms-left .ms-section').eq(3));
    });

		$(document).on('click', '#button-pricing-more', function(e){
        e.preventDefault();
        var index = $(this).index();
        scrollPage($('.ms-left .ms-section').eq(4));
    });

		$(document).on('click', '#button-reward-more', function(e){
        e.preventDefault();
        var index = $(this).index();
        scrollPage($('.ms-left .ms-section').eq(5));
    });

		$(document).on('click', '#button-roadmap-more', function(e){
        e.preventDefault();
        var index = $(this).index();
        scrollPage($('.ms-left .ms-section').eq(6));
    });

		$(document).on('click', '#button-summary-more', function(e){
        e.preventDefault();
        var index = $(this).index();
        scrollPage($('.ms-left .ms-section').eq(7));
    });
