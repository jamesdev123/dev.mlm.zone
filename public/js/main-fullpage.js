...
$(document).ready(function(){
    ...
    $('#fullpage').fullpage({
        navigation: true,
        navigationTooltips: ['Home', 'Challenge', 'Solution', 'Pricing', 'Tell a friend', 'Roadmap', 'Summary', 'Notify Me'],
        responsiveWidth: 1025
    });

    if ($(window).width() < 1025) {
        $( "#invert-slideshow" ).insertAfter( "#invert-text" );
        $( "#invert-slideshow1" ).insertAfter( "#invert-text1" );
        $( "#invert-slideshow2" ).insertAfter( "#invert-text2" );
    }
     ...
     $(window).resize(function() {
        if ($(window).width() < 1025) {
            ...
            $( "#invert-text1" ).insertAfter( "#invert-slideshow1" );
            $( "#invert-text2" ).insertAfter( "#invert-slideshow2" );
        }
    });
